(function () {
  const translations = {
    ...
    "排序": "Sort",
    "人氣優先": "Most Popular",
    "熱量由低至高": "Calories: Low to High",
    "價格由低至高": "Price: Low to High",
    "依照你選的廠區、餐次與飲食偏好，整理出目前可訂的餐點。": "Meals available for your selected site, meal period, and dietary preference.",
    "人氣首選": "Popular Pick",
